...
import DashboardSiteReview from './DashboardSiteReview';
...
const NewDashBoard = () => {
    ...
    const navigation = [
        { name: 'Home', to: `${url}`, icon: HomeIcon, current: false },
        { name: 'Documents', to: `${url}/documents`, icon: ClockIcon, current: false },
        { name: 'Upload', to: `${url}/uploadDocuments`, icon: ScaleIcon, current: false },
        { name: 'Review', to: `${path}/siteReview`, icon: CreditCardIcon, current: false },
        // { name: 'Recipients', to: '#', icon: UserGroupIcon, current: false },
        // { name: 'Reports', to: '#', icon: DocumentReportIcon, current: false },
    ]
            ...
            <div className="min-h-full">
                                        ...
                                        <div className="px-2 space-y-1">
                                            {navigation.map((item) => (
                                                <NavLink
                                                    ...
                                                    // }
                                                    // }
                                                    className="text-cyan-100 hover:text-white hover:bg-cyan-600
                ...
                <div className="lg:pl-64 flex flex-col flex-1">
                    <Switch>
                        ...
                        <Route path={`${path}/uploadDocuments`}>
                            <DashboardUploadDocuments />
                        </Route>
                        <Route path={`${path}/siteReview`}>
                            <DashboardSiteReview />
                        </Route>
                    </Switch>
                </div>
