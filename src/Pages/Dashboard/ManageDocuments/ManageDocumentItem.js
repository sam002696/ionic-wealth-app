  ...
  return (
    <>
      <tbody>
        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
          <td className="px-6 py-4 font-medium  dark:text-white whitespace-nowrap ">
            <span className="font-semibold p-2 rounded-md bg-gray-300 text-gray-600 border-none px-3">
              {_id.slice(0, 10)}
            </span>
          </td>
          <td className="px-6 py-4 text-gray-600 dark:text-white whitespace-nowrap uppercase">
            <span className="font-semibold p-2 rounded-md bg-cyan-300 text-cyan-600 border-none px-3">
              {userName}
            </span>
          </td>
          <td className="px-6 py-4">
            <a href={`mailto:${email}`} target="_blank" rel="noreferrer">
              <span className="font-semibold p-2 rounded-md bg-green-300 text-green-600 border-none px-3">
                {email}
              </span>
            </a>
          </td>
          <td className="px-6 py-4">
            <a href={clientAgreement} target="_blank" rel="noreferrer" download>
              <button className="bg-orange-200 hover:bg-orange-300 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center my-3 w-full text-orange-600">
                <svg
          ...
          <td className="px-6 py-4">
            <a href={dataProtection} target="_blank" rel="noreferrer" download>
              <button className="bg-emerald-200 hover:bg-emerald-300 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center my-3 w-full text-emerald-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2"
                  viewBox="0 0 20 20"
          ...
          <td className="px-6 py-4">
            <a href={questions} target="_blank" rel="noreferrer" download>
              <button className="bg-blue-200 hover:bg-blue-300 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center my-3 w-full text-blue-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2"
                  viewBox="0 0 20 20"
      ...
      <div
        ...
        className={`${
          modal
            ? "backdrop-blur-sm overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal  flex items-center justify-center"
            : "hidden"
        }`}
      >
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div className="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                ...
                <span className="font-semibold p-1 rounded-md bg-cyan-300 text-cyan-600 border-none px-3 text-base">
                  {userName}
                </span>
              </h3>
              <button
